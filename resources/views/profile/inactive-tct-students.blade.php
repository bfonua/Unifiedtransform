                            ...
                            <tbody>
                                @foreach ($inactive as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ data_get($student, 'users.studentInfo.tct_id', '') }}</td>
                                        <td>
                                            <a href="{{ url('user/' . data_get($student, 'users.student_code', '')) }}">
                                                {{ data_get($student, 'users.given_name', '') . ' ' . data_get($student, 'users.lst_name', '') }}
                                            </a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            {{ data_get($student, 'users.studentInfo.section.class.class_number', '') }}{{ data_get($student, 'users.studentInfo.section.section_number', '') }}
                                        </td>
                                        <td class="text-center">
                                            {{ data_get($student, 'users.studentInfo.house.house_abbrv', '') }}
                                        </td>
                                        <td class="text-center">
