    ...
    <div class="row">
        ...
        @endif
            ...
            @component('components.fee-type-form', [
                ...
                @slot('form_content')
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="name" name="name" placeholder="e.g Term 1, Term 2">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#active2">Active</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="active2">
                    <div class="panel panel-default">
                        ...
                        @if($fee_channels->first())
                            <table id="fee_channel" class='table'>
                                ...
                                <tbody>
                                    @foreach($fee_channels->where('active', 1) as $channel)
                                        <tr>
                    ...
                    <div class="panel panel-default">
                        @if($fee_channels->first())
                            <table id="fee_channel" class='table'>
                                ...
                                <tbody>
                                    @foreach($fee_channels->where('active', 0) as $channel)
                                        <tr>
                                            <td class="text-center">{{$loop->iteration}}</td>
                                            <td class="text-center">{{$channel->name}}</td>
                                            <td class="text-center">{{$channel->session}}</td>
                                            ...
                                            <td class="text-center">
                                                @component('components.fee-type-form', [
                                                    ...
                                                    @slot('buttonType')
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal{{$channel->id}}"><i class="material-icons">edit</i> 
                                                    @endslot
                                                    @slot('form_content')
                                                        <div class="form-group">
                                                            <label for="name" class="col-sm-4 control-label">@lang('Name')</label>
