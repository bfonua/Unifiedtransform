...
class UserService
{
    ...
    public function getFormNumbersArray($sections)
    {
        ...
        foreach ($sections as $section) {
            ...
            $max_form_num = (null == $max_form) ? 1 : $max_form + 1;
    ...
    public function getMaxFormNumber($section_id)
    {
        ...
        return (null == $max_form) ? 1 : $max_form + 1;
    }
    ...
    */
    ...
    {
        return (0.00 == $amount) ? '-' : number_format($amount, 2);
    }
    ...
    public function getSectionStudentsWithStudentInfo($request, $section_id)
    {
        ...
        if (isset($ignoreSessions) && 'true' == $ignoreSessions) {
