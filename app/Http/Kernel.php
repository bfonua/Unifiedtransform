...
//         \RenatoMarinho\LaravelPageSpeed\Middleware\CollapseWhitespace::class,
    ...
    protected $routeMiddleware = [
        ...
        'master.teacher' => \App\Http\Middleware\CheckMasterOrTeacher::class,
        'master.admin.accountant' => \App\Http\Middleware\CheckAdminMasterAccountant::class,
        'master.admin.accountant.teacher' => \App\Http\Middleware\CheckAdminMasterAccountantTeacher::class,
