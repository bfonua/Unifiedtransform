...
class AccountController extends Controller
{
    ...
    {
        $year = '2021';
        $budget = \App\Budget::where('session', $year)->get();
        $sectors = $this->accountSectors->getSectorsBySchoolId()->where('active', '1');

        return view('accounts.budget-view', compact('budget', 'sectors'));
    }
